(function(root, factory) {
  ...
  var DEFAULT_BIG_DEFS = [
    ...
    def({ key: 'disp_other_plasma', label: 'بلازما', group: 'الإعدامات', sg: 'أخرى' }),
    def({ key: 'disp_other_sdp', label: 'SDP', group: 'الإعدامات', sg: 'أخرى', ssg: 'صفائح' }),
    def({ key: 'disp_other_rdp', label: 'RDP', group: 'الإعدامات', sg: 'أخرى', ssg: 'صفائح' }),
